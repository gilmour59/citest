...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <form class="form-horizontal" id="frm-edit-student" action="<?= base_url('student/update/') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" required value="<?= $student['mobile'] ?>" class="form-control" id="mobile" name="mobile" placeholder="Enter phone number">
                </div>
            </div>
            <div class="form-group">
